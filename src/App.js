    ...
    <div className="login-screen">
      <div className="login-card">
        <div className="login-logo">
          <svg viewBox="0 0 28 28" width="32" height="32" fill="none" stroke="#2563eb" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className="main-page">
      ...
      <div className="category-grid main-four-grid">
        <button className="category-card" onClick={() => setShowFacilityTypeSelect(true)}>
